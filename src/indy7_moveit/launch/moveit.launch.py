...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([description_package, "urdf", robot_urdf]),
            " ",
            "name:=",
            name,
            " ",
    ...
    ompl_planning_yaml = load_yaml("indy7_moveit", "moveit_config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    if (indy_type.perform(context) == 'indyrp2') or (indy_type.perform(context) == 'indyrp2_v2'):
        controllers_yaml = load_yaml("indy7_moveit", "moveit_config/controllers_7dof.yaml")
    else:
        controllers_yaml = load_yaml("indy7_moveit", "moveit_config/controllers_6dof.yaml")
    ...
    servo_yaml = load_yaml("indy7_moveit", "moveit_config/indy_servo.yaml")
